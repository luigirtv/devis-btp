  ...
  return (
    <div>
      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-3 px-4 py-4">
        {[["/apercu/editeur", "Éditeur de devis"], ["/apercu/fiche", "Fiche d'un devis envoyé"], ["/apercu/fiche?facture=1", "Fiche d'une facture de solde"], ["/apercu/pdf", "PDF du devis"], ["/apercu/pdf?facture=1", "PDF de la facture"], ["/apercu/reglages", "Réglages"], ["/apercu/catalogue", "Catalogue"]].map(([href, l]) => (
